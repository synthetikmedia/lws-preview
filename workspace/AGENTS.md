...
**Fallback:** If the API returns overloaded/rate-limit errors, OpenClaw will automatically fall back to Claude Code CLI. No action needed from you — just retry and it will route through the fallback.
